    ...
    return Container(
      ...
      child: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(
            icon: Icon(Icons.book_outlined, color: AppColors.primaryBlue),
            selectedIcon: Icon(
              Icons.book_rounded,
              color: AppColors.primaryBlue,
            ),
          ...
          NavigationDestination(
            icon: Icon(Icons.calendar_month_outlined, color: AppColors.primaryBlue),
            selectedIcon: Icon(Icons.calendar_month, color: AppColors.primaryBlue),
            label: 'Schedule',
          ),
          NavigationDestination(
